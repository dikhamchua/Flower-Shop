<%-- 
    Document   : myOrder-list
    Created on : Mar 10, 2025, 11:12:48 AM
    Author     : FPTSHOP
--%>
...
<c:if test="${empty sessionScope.account}">
    <c:redirect url="/authen?action=login">
        <c:param name="message" value="Vui lòng đăng nhập để xem đơn hàng của bạn" />
    </c:redirect>
</c:if>
    ...
    <body>
        ...
        <div class="dashboard-main-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                <h6 class="fw-semibold mb-0">My Orders</h6>
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">
                        <a href="${pageContext.request.contextPath}/user/profile" class="d-flex align-items-center gap-1 hover-text-primary">
                            Profile
                        </a>
                    </li>
                    <li>-</li>
            ...
            <div class="card mb-24">
                <div class="card-body p-24">
                    <form action="${pageContext.request.contextPath}/orderControll" method="GET">
                        <div class="row g-3">
                            <div class="col-md-3">
                    ...
                    <nav class="mt-24">
                        <ul class="pagination justify-content-center">
                            <c:if test="${currentPage > 1}">
                                <li class="page-item">
                                    <a class="page-link" href="${pageContext.request.contextPath}/orderControll?page=${currentPage - 1}&status=${status}">
                            ...
                            <c:forEach begin="1" end="${totalPages}" var="i">
                                <li class="page-item ${i == currentPage ? 'active' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/orderControll?page=${i}&status=${status}">${i}</a>
                                </li>
                            </c:forEach>
