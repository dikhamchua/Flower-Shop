...
<head>
    ...
    <title>Edit Blog || Clothing</title>
                ...
                <form id="blogForm" action="${pageContext.request.contextPath}/admin/manage-blog?action=update" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="title" maxlength="150" value="${blog.title}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="${blog.createdAt}" readonly disabled>
                        </div>
