        ...
        <script>
            function validateForm() {
                ...
                if (username.length < 6) {
                    $('#username').siblings('.error-message').text('Username must be at least 6 characters');
                    return false;
                }
                ...
                if (!emailPattern.test(email)) {
                    $('#email').siblings('.error-message').text('Invalid email address');
                    return false;
                }
                ...
                if (firstName.length < 2) {
                    $('#firstName').siblings('.error-message').text('First name must be at least 2 characters');
                    return false;
                }
                ...
                if (lastName.length < 2) {
                    $('#lastName').siblings('.error-message').text('Last name must be at least 2 characters');
                    return false;
                }
                ...
                if (!gender) {
                    $('.gender-options').siblings('.error-message').text('Please select your gender');
                    return false;
                }
                ...
                if (!mobilePattern.test(mobile)) {
                    $('#mobile').siblings('.error-message').text('Mobile number must be 10 digits');
                    return false;
                }
                ...
                if (!passwordPattern.test(password)) {
                    $('#password').siblings('.error-message').text('Password must be at least 8 characters, including 1 uppercase, 1 lowercase, and 1 number');
                    return false;
                }
            ...
            $(document).ready(function() {
                ...
                if (errorMessage) {
                    toastr.error(errorMessage, 'Đăng ký thất bại', {
                        timeOut: 5000,
                        closeButton: true,
                        progressBar: true,
