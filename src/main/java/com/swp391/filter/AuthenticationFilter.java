...
public class AuthenticationFilter implements jakarta.servlet.Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        // Kiểm tra xem URL hiện tại có nằm trong danh sách công khai không
        
        // Kiểm tra xem người dùng đã đăng nhập chưa
        boolean isLoggedIn = (session != null && session.getAttribute("account") != null);
        
        // Nếu URL không phải công khai và người dùng chưa đăng nhập
        if (!isLoggedIn) {
            // Lưu URL hiện tại để sau khi đăng nhập có thể chuyển hướng lại
