...
CREATE TABLE `order_combo` (
  `order_combo_id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL,
  `combo_id` int DEFAULT NULL,
  `combo_name` varchar(255) DEFAULT NULL,
  `combo_discount_price` decimal(10,2) DEFAULT NULL,
  `quantity` int NOT NULL,
  `total_price` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`order_combo_id`),
  KEY `order_id` (`order_id`),
  CONSTRAINT `order_combo_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `order_combo_product`
--

DROP TABLE IF EXISTS `order_combo_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_combo_product` (
  `order_combo_product_id` int NOT NULL AUTO_INCREMENT,
  `order_combo_id` int NOT NULL,
  `product_id` int NOT NULL,
  `product_name` varchar(255) DEFAULT NULL,
  `product_price` decimal(10,2) DEFAULT NULL,
  `quantity_in_combo` int NOT NULL,
  `total_quantity` int NOT NULL,
  PRIMARY KEY (`order_combo_product_id`),
  KEY `order_combo_id` (`order_combo_id`),
  CONSTRAINT `order_combo_product_ibfk_1` FOREIGN KEY (`order_combo_id`) REFERENCES `order_combo` (`order_combo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-02  0:07:12
